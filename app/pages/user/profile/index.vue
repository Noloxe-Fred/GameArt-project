    ...
    <v-container>
      <v-row>
        ...
        <v-col>
          ...
          <p>
            En cliquant sur "Envoyer", vous recevrez un e-mail vous permettant
            de changer votre mot de passe. Merci de suivre les instructions
            qu'il contiendra:
          </p>
          <v-btn @click="changePassRequest">Envoyer</v-btn>
          <v-alert v-if="askPassRequest" type="success"
            >Demande envoyée</v-alert
          >
        </v-col>
      </v-row>
    </v-container>
